?>
			<div class="" data-section="section-footer-builder">
				<?php do_action( '_footer_copyright' ); ?>
			</div>
		<?php
		break;
	...
	case 'widget-1':
		...
		?>
				>
			<?php
			_markup_open( 'footer-widget-div' );
			_get_sidebar( 'footer-widget-1' );
			_markup_close( 'footer-widget-div' );
			?>
		</aside>
		<?php
		break;
