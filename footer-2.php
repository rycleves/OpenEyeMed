...
switch ( $astra_footer_sections ) {
	...
	case '1':
	default:
			$_footer_section_class = 'ast-small-footer-section-equally ' . astra_attr( 'ast-grid-common-col' );
		break;
}
		...
		<div class="ast-container">
			<div class="ast-small-footer-wrap" >
					...
					<?php if ( $astra_footer_section_1 ) : ?>
						<div class="ast-small-footer-section ast-small-footer-section-1 <?php echo esc_attr( $_footer_section_class ); ?>" >
							<?php
								echo $_footer_section_1; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
							?>
						</div>
				<?php endif; ?>

					<?php if ( $_footer_section_2 ) : ?>
						<div class="ast-small-footer-section ast-small-footer-section-2 <?php echo esc_attr( $astra_footer_section_class ); ?>" >
							<?php
								echo $_footer_section_2; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
							?>
						</div>
				<?php endif; ?>
